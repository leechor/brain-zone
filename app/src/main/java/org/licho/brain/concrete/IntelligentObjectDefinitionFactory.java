...
public class IntelligentObjectDefinitionFactory {
    private static IntelligentObjectDefinition create(BaseProjectDefinition baseProjectDefinition,
                                                      ObjectClass objectClass, String guidS, String name) {
        return IntelligentObjectDefinitionFactory.create(baseProjectDefinition, objectClass, guidS, name, null);
    }

    private static IntelligentObjectDefinition create(BaseProjectDefinition baseProjectDefinition,
                                                      ObjectClass objectClass, String guidS, String name, Image icon) {
        ActiveModel activeModel = baseProjectDefinition.createActiveModel(objectClass,
...
//            .updateSameIntelligentObjectDefinition(activeModel.projectDefinition[1].getIntelligentObjectDefinition());
    ...
    public static void initStandardLibrary(BaseProjectDefinition baseProjectDefinition,
                                           EnumSet<StandardType> standardType) {
        baseProjectDefinition.Icon(Resources.StandardLibraryIcon);
        BasicNode.init((NodeDefinition) IntelligentObjectDefinitionFactory.create(baseProjectDefinition,
                ObjectClass.Node, "{585953CA-C744-444b-92D9-8AF032F3E9A1}", "BasicNode", Resources.basicnode));
        TransferNode.init((NodeDefinition) IntelligentObjectDefinitionFactory.create(baseProjectDefinition,
        ...
        if (standardType.contains(StandardType.Source)) {
            Source.init((FixedDefinition) IntelligentObjectDefinitionFactory.create(baseProjectDefinition,
                    ObjectClass.Fixed, "{1D0CCF22-61F9-4fc0-9B3C-01D17E71402D}", "Source", Resources.source));
        }
        if (standardType.contains(StandardType.Sink)) {
            Sink.init((FixedDefinition) IntelligentObjectDefinitionFactory.create(baseProjectDefinition,
                    ObjectClass.Fixed, "{5F44138F-A5F7-40d1-AB9A-EEA7C5F0254E}", "Sink", Resources.sink));
        }
        if (standardType.contains(StandardType.Server)) {
            Server.init((FixedDefinition) IntelligentObjectDefinitionFactory.create(baseProjectDefinition,
        ...
        if (standardType.contains(StandardType.Workstation)) {
            Workstation.init((FixedDefinition) IntelligentObjectDefinitionFactory.create(baseProjectDefinition,
        ...
        if (standardType.contains(StandardType.Combiner)) {
            Combiner.init((FixedDefinition) IntelligentObjectDefinitionFactory.create(baseProjectDefinition,
        ...
        if (standardType.contains(StandardType.Separator)) {
            Separator.init((FixedDefinition) IntelligentObjectDefinitionFactory.create(baseProjectDefinition,
        ...
        if (standardType.contains(StandardType.Resource)) {
            Resource.init((FixedDefinition) IntelligentObjectDefinitionFactory.create(baseProjectDefinition,
        ...
        if (standardType.contains(StandardType.Vehicle)) {
            Vehicle.init((TransporterDefinition) IntelligentObjectDefinitionFactory.create(baseProjectDefinition,
        ...
        if (standardType.contains(StandardType.Worker)) {
            Worker.init((TransporterDefinition) IntelligentObjectDefinitionFactory.create(baseProjectDefinition,
                    ObjectClass.Transporter, "{5F89278E-BFE6-4867-97C5-3C24C83C5DA7}", "Worker", Resources.worker));
        }
        baseProjectDefinition.updateModel(baseProjectDefinition.get(0));
        baseProjectDefinition.updateModel(baseProjectDefinition.get(0));
        Connector.init((LinkDefinition) IntelligentObjectDefinitionFactory.create(baseProjectDefinition,
                ObjectClass.Link, "{078E9330-0F90-4770-A474-3CB06FAE1DB5}", "Connector"));
        PathDefinition.init((LinkDefinition) IntelligentObjectDefinitionFactory.create(baseProjectDefinition,
                ObjectClass.Link, "{93D39DA5-5BA1-4ae1-A526-15BDB27D48E4}", "Path", Resources.path));
        TimePath.init((LinkDefinition) IntelligentObjectDefinitionFactory.create(baseProjectDefinition,
