 ...
 *
 */
public class ProjectOperator implements IDisposable, IProjectOperator {
    ...
    public Object startTimer(int timeInterval, Object target, Action<Object> eventMethod) {
        ...
        ProjectOperator.TargetTimerAction targetTimerAction = new ProjectOperator.TargetTimerAction(timeInterval, target, eventMethod);
