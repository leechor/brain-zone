...
import com.zdpx.cctpp.enu.ElementReferenceType;
...
public class PropertyDefinitions extends BindingList<StringPropertyDefinition> implements IIdentityName,
    ...
    public com.zdpx.cctpp.concrete.RepeatingPropertyDefinition RepeatingPropertyDefinition;
    ...
    public PropertyDefinitions(GridObjectDefinition targetObject,
                               com.zdpx.cctpp.concrete.RepeatingPropertyDefinition repeatingPropertyDefinition) {
    ...
    public com.zdpx.cctpp.concrete.RepeatingPropertyDefinition getRepeatingPropertyDefinition() {
        return RepeatingPropertyDefinition;
    }

    public void setRepeatingPropertyDefinition(com.zdpx.cctpp.concrete.RepeatingPropertyDefinition repeatingPropertyDefinition) {
        this.RepeatingPropertyDefinition = repeatingPropertyDefinition;
    }
    ...
    private void actionProperties(Properties properties, PropertyDefinitions propertyDefinitions,
        ...
        for (int i = 0; i < definitions.size(); i++) {
            ...
            com.zdpx.cctpp.concrete.RepeatingPropertyDefinition repeatingPropertyDefinition =
                    (com.zdpx.cctpp.concrete.RepeatingPropertyDefinition) stringPropertyDefinition;
